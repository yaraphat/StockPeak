        ...
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="p-3 bg-[var(--background)] rounded-lg text-xs text-[var(--color-muted)] font-bengali">
              ৭ দিনের ফ্রি ট্রায়াল। এরপর ৳২৬০/মাস। bKash / Nagad — কোনো কার্ড লাগবে না।
            </div>
          ...
          <button onClick={() => signIn("google", { callbackUrl: "/welcome" })} className="w-full border border-[var(--color-border)] font-medium py-2.5 rounded-lg hover:bg-[var(--background)] transition-colors text-sm flex items-center justify-center gap-2">
